...
val achievements: AchievementList = mapOf(
    "Personal Records" to listOf(
        ...
        Achievement(sortOrder = 3, name = "Fastest 5K", imageId = R.drawable.fastest_5k),
        Achievement(sortOrder = 4, name = "Fastest 10k", imageId = R.drawable.fastest_10k),
        Achievement(sortOrder = 5, name = "Half Marathon", imageId = R.drawable.fastest_half_marathon),
        Achievement(sortOrder = 6, name = "Marathon", imageId = R.drawable.fastest_marathon),
    ),
    "Virtual Races" to listOf(
        Achievement(sortOrder = 1, name = "Virtual Half Marathon Race", imageId = R.drawable.virtual_half_marathon_race),
        Achievement(sortOrder = 2, name = "Tokyo-Hakone Ekiden 2020", imageId = R.drawable.tokyo_kakone_ekiden),
        Achievement(sortOrder = 3, name = "Virtual 10k Race", imageId = R.drawable.virtual_10k_race),
        Achievement(sortOrder = 4, name = "Hakone Ekiden", imageId = R.drawable.hakone_ekiden),
        Achievement(sortOrder = 5, name = "Mizuno Singapore Ekidon 2015", imageId = R.drawable.mizuno_singapore_ekiden),
        Achievement(sortOrder = 6, name = "Virtual 5K Race", imageId = R.drawable.virtual_5k_race),
    ),
)